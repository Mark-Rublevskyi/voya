...
function passValid(form,pass1,pass12,submit)//проверка длины пароля
{
  ...
  PASS1count=document.getElementById('password').value.length;//количество символов в пароле
...
function isRavno(form,pass1,pass2,pass22,submit)//сравниваем пароли
 {
 	PASS1=document.getElementById('password').value;//первый пароль
 	PASS1count=document.getElementById('password').value.length;//количество символов в 1 пароле
    PASS2=document.getElementById('password-check').value;//второй пароль
